...
export interface GraphQLModuleOptions<Config, Session extends object, Context> {
     ...
     */
    resolvers?: GraphQLModuleOption<MaybePromise<IResolvers<any, ModuleContext<Context>> | Array<IResolvers<any, ModuleContext<Context>>>>, Config, Session, Context>;
    /**
 ...
 * @constructor
 */
export declare const ModuleConfig: (module: string | GraphQLModule<any, any, any> | ((module?: void) => string | GraphQLModule<any, any, any>)) => symbol;
 ...
 */
export declare class GraphQLModule<Config = any, Session extends object = any, Context = any> {
    private _options;
    ...
    readonly resolversAsync: Promise<IResolvers<any, ModuleContext<Context>>>;
    ...
    readonly selfResolversAsync: Promise<IResolvers<any, ModuleContext<Context>>>;
    readonly selfImports: GraphQLModule<any, Session, any>[];
